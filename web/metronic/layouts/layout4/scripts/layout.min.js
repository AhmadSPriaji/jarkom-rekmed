  ...
  var e = "layouts/layout4/img/",
    ...
    i = function () {
      var e,
        ...
        t = $("body");
      if (
        t.hasClass("page-footer-fixed") === !0 &&
        t.hasClass("page-sidebar-fixed") === !1
      ) {
        var o =
        ...
        if (t.hasClass("page-sidebar-fixed"))
          (e = n() - 10),
            t.hasClass("page-footer-fixed") === !1 &&
              (e -= $(".page-footer").outerHeight(!0));
        else {
          var r = $(".page-header").outerHeight(!0),
            p = $(".page-footer").outerHeight(!0);
          (e =
            App.getViewPort().width < s
              ? App.getViewPort().height - r - p
              : i.height() - 10),
            e + r + p <= App.getViewPort().height &&
              (e = App.getViewPort().height - r - p - 45);
        }
        ...
        ("click" === e || "set" === e
          ...
          : "match" === e &&
            t.find("li > a").each(function () {
              ...
              return e.length > 1 && i.substr(1, e.length - 1) == e.substr(1)
                ? void (a = $(this))
                : void 0;
            }),
        a &&
          0 != a.size() &&
          "javascript:;" !== a.attr("href").toLowerCase() &&
          "#" !== a.attr("href").toLowerCase())
      ) {
        parseInt(t.data("slide-speed")), t.data("keep-expanded");
        t.find("li.active").removeClass("active"),
          t.find("li > a > .selected").remove(),
          t.hasClass("page-sidebar-menu-hover-submenu") === !1
            ? t.find("li.open").each(function () {
                0 === $(this).children(".sub-menu").size() &&
                  ($(this).removeClass("open"),
                  $(this).find("> a > .arrow.open").removeClass("open"));
              })
            : t.find("li.open").removeClass("open"),
          a.parents("li").each(function () {
            $(this).addClass("active"),
              $(this).find("> a > span.arrow").addClass("open"),
              1 === $(this).parent("ul.page-sidebar-menu").size() &&
                $(this).find("> a").append('<span class="selected"></span>'),
              1 === $(this).children("ul.sub-menu").size() &&
                $(this).addClass("open");
          }),
          "click" === e &&
            App.getViewPort().width < s &&
    ...
    o = function () {
      $(".page-sidebar").on("click", "li > a", function (e) {
        if (
          !(
            App.getViewPort().width >= s &&
            1 === $(this).parents(".page-sidebar-menu-hover-submenu").size()
          )
        ) {
          ...
          if (!$(this).next().hasClass("sub-menu always-open")) {
            ...
            n.is(":visible")
              ? ($(".arrow", $(this)).removeClass("open"),
                ...
                n.slideUp(p, function () {
                  r === !0 &&
                    $("body").hasClass("page-sidebar-closed") === !1 &&
                    ($("body").hasClass("page-sidebar-fixed")
                      ? o.slimScroll({ scrollTo: t.position().top })
                      : App.scrollTo(t, l)),
                    i();
                }))
              : ($(".arrow", $(this)).addClass("open"),
                $(this).parent().addClass("open"),
                n.slideDown(p, function () {
                  r === !0 &&
                    $("body").hasClass("page-sidebar-closed") === !1 &&
                    ($("body").hasClass("page-sidebar-fixed")
                      ? o.slimScroll({ scrollTo: t.position().top })
    ...
    r = function () {
      ...
      return (
        ...
        0 === $(".page-sidebar-fixed").size()
          ...
          : void (
              App.getViewPort().width >= s &&
              (e.attr("data-height", n()), App.initSlimScroll(e), i())
            )
      );
    },
    p = function () {
    ...
    l = function () {
      $(".page-header").on("click", ".search-form", function (e) {
        ...
        $(".page-header").on(
          ...
          function (e) {
            return 13 == e.which
              ? ($(this).closest(".search-form").submit(), !1)
              : void 0;
          }
        ),
        $(".page-header").on(
    ...
    c = function () {
      ...
      navigator.userAgent.match(/iPhone|iPad|iPod/i)
        ? $(window).bind("touchend touchcancel touchleave", function (s) {
            $(this).scrollTop() > e
        ...
        $(".scroll-to-top").click(function (e) {
          return (
            e.preventDefault(), $("html, body").animate({ scrollTop: 0 }, a), !1
          );
        });
    };
  return {
