...
var Demo = (function () {
  ...
  var handleTheme = function () {
    ...
    $(".theme-colors > li", panel).click(function () {
      ...
      if (color === "dark") {
        $(".page-actions .btn")
          .removeClass("red-haze")
          .addClass("btn-default btn-transparent");
      } else {
        $(".page-actions .btn")
          .removeClass("btn-default btn-transparent")
          .addClass("red-haze");
      }
    });
    ...
    $(
      ".layout-option, .page-header-top-dropdown-style-option, .page-header-option, .sidebar-option, .page-footer-option, .sidebar-pos-option, .sidebar-style-option, .sidebar-menu-option",
      panel
    ).change(setLayout);
  };
