  ...
  var e = function () {
      ...
      var a = function () {
          $("body")
            ...
            1 === $(".page-container").parent(".container").size() &&
              $(".page-container").insertAfter("body > .clearfix"),
            1 === $(".page-footer > .container").size()
              ? $(".page-footer").html($(".page-footer > .container").html())
              : 1 === $(".page-footer").parent(".container").size() &&
        ...
        t = function () {
          ...
          o != t && App.runResizeHandlers(),
            ...
            $("body").hasClass("page-full-width") === !1 &&
              ("fixed" === d
            ...
            "hover" === p
              ? "fixed" == d
                ? ($(".sidebar-menu-option", e).val("accordion"),
                  alert(
        ...
        d = function (e) {
          ...
          $("#style_color").attr(
            "href",
            Layout.getLayoutCssPath() + "themes/" + a + ".min.css"
          );
        };
      $(".theme-colors > li", e).click(function () {
        ...
        $("body").hasClass("page-footer-fixed") &&
          $(".page-footer-option", e).val("fixed"),
        $("body").hasClass("page-sidebar-reversed") &&
          $(".sidebar-pos-option", e).val("right"),
        $(".page-sidebar-menu").hasClass("page-sidebar-menu-light") &&
          $(".sidebar-style-option", e).val("light"),
        $(".page-sidebar-menu").hasClass("page-sidebar-menu-hover-submenu") &&
          $(".sidebar-menu-option", e).val("hover");
    ...
    a = function (e) {
      ...
      (a = App.isRTL() ? a + "-rtl" : a),
        $("#style_components").attr(
          "href",
          App.getGlobalCssPath() + a + ".min.css"
        ),
    ...
    init: function () {
      e(),
        ...
        "undefined" != typeof Cookies &&
          "rounded" === Cookies.get("layout-style-option") &&
          (a(Cookies.get("layout-style-option")),
