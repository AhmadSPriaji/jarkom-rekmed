...
var Datatable = function () {
  ...
  return {
    ...
    init: function (options) {
            ...
            ajax: {
              ...
              error: function () {
                ...
                App.alert({
                  ...
                  icon: "warning",
                  message:
                    tableOptions.dataTable.language
                      .metronicAjaxRequestGeneralError,
                  container: tableWrapper,
                  place: "prepend",
                });
      ...
      $.fn.dataTableExt.oStdClasses.sFilterInput =
        "form-control input-xs input-sm input-inline";
      $.fn.dataTableExt.oStdClasses.sLengthSelect =
        "form-control input-xs input-sm input-inline";
      ...
      if ($(".table-actions-wrapper", tableContainer).size() === 1) {
        $(".table-group-actions", tableWrapper).html(
          $(".table-actions-wrapper", tableContainer).html()
        ); // place the panel inside the wrapper
