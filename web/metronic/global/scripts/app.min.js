  ...
  var t,
    ...
    b = function () {
      if ($().uniform) {
        ...
        t.size() > 0 &&
          t.each(function () {
            0 === $(this).parents(".checker").size() &&
              ($(this).show(), $(this).uniform());
          });
      }
    },
    g = function () {
    ...
    x = function () {
      $(".tooltips").tooltip(),
        ...
        $(
          ".portlet > .portlet-title > .tools > .collapse, .portlet > .portlet-title > .tools > .expand"
        ).tooltip({ container: "body", title: "Collapse/Expand" });
    },
    I = function () {
        ...
        if ("1" === $(this).attr("data-initialized")) {
          ...
          $(this).attr("data-handle-color") &&
            ...
            $(this).attr("data-always-visible") &&
              (t["data-always-visible"] = $(this).attr("data-always-visible")),
