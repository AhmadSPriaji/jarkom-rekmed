(function (c) {
  var j = {
      init: function (a) {
        ...
        a && c.extend(b, a);
        b.color = c("<div style='background:" + b.color + "'></div>").css(
          "background-color"
        );
    ...
    g = function (a, b, d) {
      ...
      a.glow
        ? ((e["box-shadow"] = "0px 0px " + parseInt(d / 1.5) + "px " + h),
          (userAgent = navigator.userAgent || ""),
          /(chrome)[ \/]([\w.]+)/.test(userAgent.toLowerCase()) &&
            ((e["outline-offset"] = d + "px"),
            (e["outline-radius"] = "100 px")))
        : (e["outline-offset"] = d + "px");
      c(b).css(e);
